...
const SmartSwitches: React.FC = () => {
  ...
  const switches = [
    ...
    },
    {
      ...
      image: "/images/products/mixswitch-bach-smart-switch-four-colors.png",
      price: "£69",
      priceRange: "£69 - £99",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/smart-switches-orvibo.png",
      price: "£129",
      priceRange: "£129 - £199",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/smart-wifi-switch-orvibo.jpg",
      price: "£49",
      priceRange: "£49 - £79",
      features: [
        "WiFi connectivity",
    ...
    },
    {
      ...
      image: "/images/products/smart-dimmer-switch-orvibo.jpg",
      price: "£79",
      priceRange: "£79 - £109",
      features: [
    ...
    },
    {
      ...
      image: "/images/products/mixpad-d1-switch.jpg",
      price: "£159",
      priceRange: "£159 - £229",
      features: [
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f8f6f3] to-[#faf7f3]">
        ...
        {/* Hero Section */}
       <section className="pt-10 pb-16 relative overflow-hidden bg-gradient-to-br from-[#231c14] via-[#2a1f17] to-[#1a1410]">
  {/* Background Image with Overlay */} 
  <div className="absolute inset-0">
    <img 
      src="/images/switches-banner.png" 
      alt="Luxury background" 
      className="w-full h-full object-cover opacity-30"
    />
    <div className="absolute inset-0 bg-gradient-to-r from-[#231c14]/70 to-[#1a1410]/55"></div>
  </div>
  ...
  <div className="container mx-auto px-4 lg:px-8 relative z-10">
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        <div className="bg-gradient-to-r from-[#b69777] to-[#907252] text-white mb-6 text-sm px-4 py-2 rounded-full inline-block shadow-lg">
          Orvibo Smart Switches
        </div>
        <h1 className="text-4xl lg:text-6xl font-extrabold text-white mb-6 leading-tight tracking-wide drop-shadow-lg">
          Where Technology{" "}
          <span className="bg-gradient-to-r from-[#b69777] via-[#b89773] to-[#907252] bg-clip-text text-transparent drop-shadow-md">
            Meets Artistry
          </span>
        </h1>
        <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-xl drop-shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            className="bg-gradient-to-r from-[#b69777] to-[#907252] text-white hover:from-[#907252] hover:to-[#b69777] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 px-8 py-4 text-lg rounded-full font-semibold flex items-center justify-center"
          ...
          <button
            className="bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white/20 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 px-8 py-4 text-lg rounded-full font-semibold flex items-center justify-center"
            onClick={() =>
                  ...
                  <div className={`relative overflow-hidden ${viewMode === 'list' ? 'w-64 flex-shrink-0' : ''}`}>
                    <img 
                      ...
                      className={`object-cover group-hover:scale-110 transition-transform duration-300 ${
                        viewMode === 'list' ? 'w-full h-full' : 'w-full h-74'
                      }`}
                    />
