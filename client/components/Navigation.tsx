...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Smart Walls', to: '/smart-walls', children: [
    ...
    { name: 'Smart Walls for Bedroom', to: '/smart-walls/bedroom'},
    { name: 'Smart Walls for Kitchen', to: '/smart-walls/kitchen' },
    { name: 'Smart Walls for Bathroom', to: '/smart-walls/bathroom' },
    { name: 'Smart Walls for the Office', to: '/smart-walls/office' },
    { name: 'Smart Walls for Restaurant', to: '/smart-walls/restaurants' },
    { name: 'Smart Walls for Events', to: '/smart-walls/events' },
